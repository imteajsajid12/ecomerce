            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" action="" method="post" class="validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <button class="btn btn-danger btn-lg btn-block editbtn" type="submit">Pay Now (₹100)</button>
                                </div>
                                <button type="button" class="btn btn-outline-info btn-icon mr-1 editbtn">
                                    <i class="zmdi zmdi-edit"></i>kkljal;l</button>
                            </div>
...
<script>
    function show_my_receipt() {
         ...
         var page = '/Payment';
         var myWindow = window.open(page, "_blank", "scrollbars=yes,width=700,height=500,top=400");
         // focus on the popup //
         myWindow.focus();
